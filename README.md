...
![Source SVG](docs/text-templating.svg)

<sub><sup>**Result**</small><br/>
![Result](docs/text-templating.gif)
...
<sub><sup>**SVG Source**</sup></sub><br/>
![Source SVG](docs/text-alignment.svg)

<sub><sup>**Result**</sup></sub><br/>
![Result](docs/text-alignment.gif)
...
<sub><sup>**SVG Source**</sup></sub><br/>
![Source SVG](docs/transform-origin.svg)

<sub><sup>**Result**</sup></sub><br/>
![Result](docs/transform-origin.gif)
...
<sub><sup>**SVG Source**</sup></sub><br/>
![Source SVG](docs/transform-scale.svg)

<sub><sup>**Result**</sup></sub><br/>
![Result](docs/transform-scale.gif)
...
<sub><sup>**SVG Source**</sup></sub><br/>
![Source SVG](docs/transform-rotate.svg)

<sub><sup>**Result**</sup></sub><br/>
![Result](docs/transform-rotate.gif)
...
<sub><sup>**SVG Source**</sup></sub><br/>
![Source SVG](docs/transform-position.svg)

<sub><sup>**Result**</sup></sub><br/>
![Result](docs/transform-position.gif)

Special behavior is given to guides that can be used to define a path for the motion.

<sub><sup>**SVG Source**</sup></sub><br/>
![Source SVG](docs/transform-position-path.svg)

<sub><sup>**Result**</sup></sub><br/>
![Result](docs/transform-position-path.gif)
